...
public class InventorySupplierDetailFromController {
    ...
    @FXML
    private TableView<InventorySupplier> tblOrderCart;
    @FXML
    ...
    private void getInventoryIds() throws ClassNotFoundException {
...
*/
    ...
    @FXML
    void btnAddOnAction(ActionEvent event) throws NumberFormatException, IllegalArgumentException, ClassNotFoundException {
        try {
    ...
    void btnDeleteOnAction(ActionEvent event) throws ClassNotFoundException {
        ObservableList<InventorySupplier> selectedInventorySupplierDetail = tblOrderCart.getSelectionModel().getSelectedItems();
